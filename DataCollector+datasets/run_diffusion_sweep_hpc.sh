...
#SBATCH --output=slurm-diffusion-%A_%a.out
#SBATCH --error=slurm-diffusion-%A_%a.err
...
srun /scratch/ajain3/conda/envs/diffusion_env/bin/python -u "$SCRIPT_DIR/sweep_diffusion_hpc.py"
