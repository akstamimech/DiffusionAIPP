...
#SBATCH --output=slurm-imit-chunk-%A_%a.out
#SBATCH --error=slurm-imit-chunk-%A_%a.err
...
srun /scratch/ajain3/conda/envs/diffusion_env/bin/python -u "$SCRIPT_DIR/sweep_imitation_execution_chunk_hpc.py"
