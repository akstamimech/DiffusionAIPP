...
#SBATCH --output=slurm-lawnmower-%A_%a.out
#SBATCH --error=slurm-lawnmower-%A_%a.err
...
srun /scratch/ajain3/conda/envs/diffusion_env/bin/python -u "$SCRIPT_DIR/sweep_lawnmower_hpc.py"
