...
#SBATCH --output=slurm-greedy-%A_%a.out
#SBATCH --error=slurm-greedy-%A_%a.err
...
srun /scratch/ajain3/conda/envs/diffusion_env/bin/python -u "$SCRIPT_DIR/sweep_greedy_hpc.py"
